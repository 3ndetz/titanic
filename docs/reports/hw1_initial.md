...
> Версии Docker и другого предварительного ПО указаны в документации getting started.
...
4. Поставил cookiecutter
   ...
   `uv pip install cookiecutter-data-science`
    ...
    Поставилась версия этого пакета 2.3.0
...
9. Добавил точные версии пакетов, обновил ридми
...
Версия образа докера, которая подтягивалась: ghcr.io/astral-sh/uv:python3.12-bookworm-slim@sha256:1dc95ac11811c9a5ab2c19f37222b63e6a7f035fa98045203b134260b2143cd1
от 2025.11.20
